regimens_dict = {'Heavy' : {'Mon': 'Chest','Tue': 'Biceps','Wed': 'Rest','Thu': 'Back','Fri': 'Triceps','Sat': 'Rest','Sun': 'Rest'}, 'intermediate': {'Mon': 'Chest','Tue': 'Biceps','Wed': 'Cardio/Abs','Thu': 'Back','Fri': 'Triceps','Sat': 'Legs','Sun': 'Rest'}, 'Beginner': {'Mon': 'Chest','Tue': 'Biceps','Wed': 'Abs/Cardio','Thu': 'Back','Fri': 'Triceps','Sat': 'Legs','Sun': 'Cardio'}, 'Competition': {'Mon': 'Chest','Tue': 'Biceps','Wed': 'Cardio','Thu': 'Back','Fri': 'Triceps','Sat': 'Cardio','Sun': 'Cardio'}}
member_details_dict = {}
...
class SuperUser:
    ...
    try:
        ...
        def superuser_menu(self):
            print("Here are your options, GYM MANAGER \n 1. Create Member\n 2. View Member\n 3. Delete Member\
            \n 4. Update Member\n 5. Create Regimen\n 6. View Regimen\n 7. Delete Regimen\
            \n 8. Update Regimen\n 9. Exit")                        #GYM MANAGER - Superuser
        ...
        def create_member(self):
            print("Okay Manager, let's create a new member!\n")
        ...
        def select_regimen(self, bmi):
            while(isinstance(bmi,float) == False):
                ...
                if(bmi < 18.5):
                    regimen = regimens_dict['Heavy']
                elif(bmi >= 18.5 and bmi < 25):
                    regimen = regimens_dict['intermediate']
                elif(bmi >= 25 and bmi < 30):
                    regimen = regimens_dict['Beginner']
                elif(bmi >= 30):   
                    regimen = regimens_dict['Competition']
...
class Member:
    def __init__(self):
        ...
        if self.num in member_details_dict:
            print("Welcome, {} to SHARON'S GYM!".format(member_details_dict[self.num]['Full Name']))
            self.member_menu()
        else:
